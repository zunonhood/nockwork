...
var require_buffer = __commonJS({
  "node_modules/buffer/index.js"(exports) {
    ...
    function Buffer7(arg2, encodingOrOffset, length) {
    ...
    function utf8Write(buf, string3, offset2, length) {
      return blitBuffer(utf8ToBytes2(string3, buf.length - offset2), buf, offset2, length);
    }
    ...
    Buffer7.prototype.write = function write(string3, offset2, length, encoding) {
      if (offset2 === void 0) {
        encoding = "utf8";
        length = this.length;
        offset2 = 0;
    ...
    Buffer7.prototype.readUintLE = Buffer7.prototype.readUIntLE = function readUIntLE(offset2, byteLength2, noAssert) {
      offset2 = offset2 >>> 0;
    ...
    Buffer7.prototype.readUintBE = Buffer7.prototype.readUIntBE = function readUIntBE(offset2, byteLength2, noAssert) {
      offset2 = offset2 >>> 0;
      byteLength2 = byteLength2 >>> 0;
      if (!noAssert) {
    ...
    Buffer7.prototype.readUint8 = Buffer7.prototype.readUInt8 = function readUInt8(offset2, noAssert) {
      offset2 = offset2 >>> 0;
      if (!noAssert) checkOffset(offset2, 1, this.length);
      return this[offset2];
    };
    Buffer7.prototype.readUint16LE = Buffer7.prototype.readUInt16LE = function readUInt16LE(offset2, noAssert) {
      offset2 = offset2 >>> 0;
      if (!noAssert) checkOffset(offset2, 2, this.length);
      return this[offset2] | this[offset2 + 1] << 8;
    };
    Buffer7.prototype.readUint16BE = Buffer7.prototype.readUInt16BE = function readUInt16BE(offset2, noAssert) {
      offset2 = offset2 >>> 0;
      if (!noAssert) checkOffset(offset2, 2, this.length);
      return this[offset2] << 8 | this[offset2 + 1];
    };
    Buffer7.prototype.readUint32LE = Buffer7.prototype.readUInt32LE = function readUInt32LE(offset2, noAssert) {
      offset2 = offset2 >>> 0;
      if (!noAssert) checkOffset(offset2, 4, this.length);
      return (this[offset2] | this[offset2 + 1] << 8 | this[offset2 + 2] << 16) + this[offset2 + 3] * 16777216;
    };
    Buffer7.prototype.readUint32BE = Buffer7.prototype.readUInt32BE = function readUInt32BE(offset2, noAssert) {
      offset2 = offset2 >>> 0;
      if (!noAssert) checkOffset(offset2, 4, this.length);
      return this[offset2] * 16777216 + (this[offset2 + 1] << 16 | this[offset2 + 2] << 8 | this[offset2 + 3]);
    };
    Buffer7.prototype.readBigUInt64LE = defineBigIntMethod(function readBigUInt64LE(offset2) {
      offset2 = offset2 >>> 0;
    ...
    Buffer7.prototype.readBigUInt64BE = defineBigIntMethod(function readBigUInt64BE(offset2) {
      offset2 = offset2 >>> 0;
      validateNumber(offset2, "offset");
      const first = this[offset2];
      const last = this[offset2 + 7];
    ...
    Buffer7.prototype.readIntLE = function readIntLE(offset2, byteLength2, noAssert) {
      offset2 = offset2 >>> 0;
      byteLength2 = byteLength2 >>> 0;
      if (!noAssert) checkOffset(offset2, byteLength2, this.length);
      let val = this[offset2];
    ...
    Buffer7.prototype.readIntBE = function readIntBE(offset2, byteLength2, noAssert) {
      offset2 = offset2 >>> 0;
      byteLength2 = byteLength2 >>> 0;
      if (!noAssert) checkOffset(offset2, byteLength2, this.length);
      let i = byteLength2;
    ...
    Buffer7.prototype.readInt8 = function readInt8(offset2, noAssert) {
      offset2 = offset2 >>> 0;
      if (!noAssert) checkOffset(offset2, 1, this.length);
      if (!(this[offset2] & 128)) return this[offset2];
      return (255 - this[offset2] + 1) * -1;
    };
    Buffer7.prototype.readInt16LE = function readInt16LE(offset2, noAssert) {
      offset2 = offset2 >>> 0;
      if (!noAssert) checkOffset(offset2, 2, this.length);
      const val = this[offset2] | this[offset2 + 1] << 8;
      return val & 32768 ? val | 4294901760 : val;
    };
    Buffer7.prototype.readInt16BE = function readInt16BE(offset2, noAssert) {
      offset2 = offset2 >>> 0;
      if (!noAssert) checkOffset(offset2, 2, this.length);
      const val = this[offset2 + 1] | this[offset2] << 8;
      return val & 32768 ? val | 4294901760 : val;
    };
    Buffer7.prototype.readInt32LE = function readInt32LE(offset2, noAssert) {
      offset2 = offset2 >>> 0;
      if (!noAssert) checkOffset(offset2, 4, this.length);
      return this[offset2] | this[offset2 + 1] << 8 | this[offset2 + 2] << 16 | this[offset2 + 3] << 24;
    };
    Buffer7.prototype.readInt32BE = function readInt32BE(offset2, noAssert) {
      offset2 = offset2 >>> 0;
      if (!noAssert) checkOffset(offset2, 4, this.length);
      return this[offset2] << 24 | this[offset2 + 1] << 16 | this[offset2 + 2] << 8 | this[offset2 + 3];
    };
    Buffer7.prototype.readBigInt64LE = defineBigIntMethod(function readBigInt64LE(offset2) {
      offset2 = offset2 >>> 0;
      validateNumber(offset2, "offset");
      const first = this[offset2];
      const last = this[offset2 + 7];
    ...
    Buffer7.prototype.readBigInt64BE = defineBigIntMethod(function readBigInt64BE(offset2) {
      offset2 = offset2 >>> 0;
      validateNumber(offset2, "offset");
      const first = this[offset2];
      const last = this[offset2 + 7];
    ...
    Buffer7.prototype.readFloatLE = function readFloatLE(offset2, noAssert) {
      offset2 = offset2 >>> 0;
      if (!noAssert) checkOffset(offset2, 4, this.length);
      return ieee754.read(this, offset2, true, 23, 4);
    };
    Buffer7.prototype.readFloatBE = function readFloatBE(offset2, noAssert) {
      offset2 = offset2 >>> 0;
      if (!noAssert) checkOffset(offset2, 4, this.length);
      return ieee754.read(this, offset2, false, 23, 4);
    };
    Buffer7.prototype.readDoubleLE = function readDoubleLE(offset2, noAssert) {
      offset2 = offset2 >>> 0;
      if (!noAssert) checkOffset(offset2, 8, this.length);
      return ieee754.read(this, offset2, true, 52, 8);
    };
    Buffer7.prototype.readDoubleBE = function readDoubleBE(offset2, noAssert) {
      offset2 = offset2 >>> 0;
      if (!noAssert) checkOffset(offset2, 8, this.length);
    ...
    Buffer7.prototype.writeUintLE = Buffer7.prototype.writeUIntLE = function writeUIntLE(value, offset2, byteLength2, noAssert) {
      value = +value;
      offset2 = offset2 >>> 0;
      byteLength2 = byteLength2 >>> 0;
      if (!noAssert) {
    ...
    Buffer7.prototype.writeUintBE = Buffer7.prototype.writeUIntBE = function writeUIntBE(value, offset2, byteLength2, noAssert) {
      value = +value;
      offset2 = offset2 >>> 0;
      byteLength2 = byteLength2 >>> 0;
      if (!noAssert) {
    ...
    Buffer7.prototype.writeUint8 = Buffer7.prototype.writeUInt8 = function writeUInt8(value, offset2, noAssert) {
      value = +value;
      offset2 = offset2 >>> 0;
    ...
    Buffer7.prototype.writeUint16LE = Buffer7.prototype.writeUInt16LE = function writeUInt16LE(value, offset2, noAssert) {
      value = +value;
      offset2 = offset2 >>> 0;
    ...
    Buffer7.prototype.writeUint16BE = Buffer7.prototype.writeUInt16BE = function writeUInt16BE(value, offset2, noAssert) {
      value = +value;
      offset2 = offset2 >>> 0;
      if (!noAssert) checkInt(this, value, offset2, 2, 65535, 0);
    ...
    Buffer7.prototype.writeUint32LE = Buffer7.prototype.writeUInt32LE = function writeUInt32LE(value, offset2, noAssert) {
      value = +value;
      offset2 = offset2 >>> 0;
    ...
    Buffer7.prototype.writeUint32BE = Buffer7.prototype.writeUInt32BE = function writeUInt32BE(value, offset2, noAssert) {
      value = +value;
      offset2 = offset2 >>> 0;
      if (!noAssert) checkInt(this, value, offset2, 4, 4294967295, 0);
    ...
    Buffer7.prototype.writeBigUInt64LE = defineBigIntMethod(function writeBigUInt64LE(value, offset2 = 0) {
      return wrtBigUInt64LE(this, value, offset2, BigInt(0), BigInt("0xffffffffffffffff"));
    });
    Buffer7.prototype.writeBigUInt64BE = defineBigIntMethod(function writeBigUInt64BE(value, offset2 = 0) {
      return wrtBigUInt64BE(this, value, offset2, BigInt(0), BigInt("0xffffffffffffffff"));
    });
    Buffer7.prototype.writeIntLE = function writeIntLE(value, offset2, byteLength2, noAssert) {
      value = +value;
      offset2 = offset2 >>> 0;
      if (!noAssert) {
    ...
    Buffer7.prototype.writeIntBE = function writeIntBE(value, offset2, byteLength2, noAssert) {
      value = +value;
      offset2 = offset2 >>> 0;
      if (!noAssert) {
        const limit = Math.pow(2, 8 * byteLength2 - 1);
    ...
    Buffer7.prototype.writeInt8 = function writeInt8(value, offset2, noAssert) {
      value = +value;
      offset2 = offset2 >>> 0;
    ...
    Buffer7.prototype.writeInt16LE = function writeInt16LE(value, offset2, noAssert) {
      value = +value;
      offset2 = offset2 >>> 0;
    ...
    Buffer7.prototype.writeInt16BE = function writeInt16BE(value, offset2, noAssert) {
      value = +value;
      offset2 = offset2 >>> 0;
      if (!noAssert) checkInt(this, value, offset2, 2, 32767, -32768);
      this[offset2] = value >>> 8;
    ...
    Buffer7.prototype.writeInt32LE = function writeInt32LE(value, offset2, noAssert) {
      value = +value;
      offset2 = offset2 >>> 0;
    ...
    Buffer7.prototype.writeInt32BE = function writeInt32BE(value, offset2, noAssert) {
      value = +value;
      offset2 = offset2 >>> 0;
      if (!noAssert) checkInt(this, value, offset2, 4, 2147483647, -2147483648);
    ...
    Buffer7.prototype.writeBigInt64LE = defineBigIntMethod(function writeBigInt64LE(value, offset2 = 0) {
      return wrtBigUInt64LE(this, value, offset2, -BigInt("0x8000000000000000"), BigInt("0x7fffffffffffffff"));
    });
    Buffer7.prototype.writeBigInt64BE = defineBigIntMethod(function writeBigInt64BE(value, offset2 = 0) {
    ...
    Buffer7.prototype.writeFloatLE = function writeFloatLE(value, offset2, noAssert) {
      return writeFloat(this, value, offset2, true, noAssert);
    };
    Buffer7.prototype.writeFloatBE = function writeFloatBE(value, offset2, noAssert) {
    ...
    Buffer7.prototype.writeDoubleLE = function writeDoubleLE(value, offset2, noAssert) {
      return writeDouble(this, value, offset2, true, noAssert);
    };
    Buffer7.prototype.writeDoubleBE = function writeDoubleBE(value, offset2, noAssert) {
    ...
    (function(module2, exports2) {
      ...
      try {
        if (typeof window !== "undefined" && typeof window.Buffer !== "undefined") {
          ...
          Buffer7 = require_buffer2().Buffer;
        }
      } catch (e) {
      }
...
var require_safe_buffer = __commonJS({
  "node_modules/safe-buffer/index.js"(exports, module) {
    ...
    function SafeBuffer(arg2, encodingOrOffset, length) {
      return Buffer7(arg2, encodingOrOffset, length);
    }
    ...
    var Union = class extends Layout {
      constructor(discr, defaultLayout, property) {
        ...
        if (discr instanceof UInt || discr instanceof UIntBE) {
          discriminator2 = new UnionLayoutDiscriminator(new OffsetLayout(discr));
        } else if (discr instanceof ExternalLayout && discr.isCount()) {
          discriminator2 = new UnionLayoutDiscriminator(discr);
...
function memoized(fn) {
  ...
  return (arg2, ...args) => {
    const val = map.get(arg2);
    if (val !== void 0)
      return val;
    const computed = fn(arg2, ...args);
    map.set(arg2, computed);
    return computed;
  };
}
...
var MessageAccountKeys = class {
  ...
  compileInstructions(instructions) {
    ...
    return instructions.map((instruction2) => {
      return {
        programIdIndex: findKeyIndex(instruction2.programId),
        accountKeyIndexes: instruction2.keys.map((meta) => findKeyIndex(meta.pubkey)),
        data: instruction2.data
      };
    });
  }
};
...
var Message = class _Message {
  ...
  serialize() {
    ...
    const instructions = this.instructions.map((instruction2) => {
      const {
        accounts,
        programIdIndex
      } = instruction2;
      const data = Array.from(import_bs58.default.decode(instruction2.data));
      let keyIndicesCount = [];
    ...
    instructions.forEach((instruction2) => {
      const instructionLayout = BufferLayout.struct([BufferLayout.u8("programIdIndex"), BufferLayout.blob(instruction2.keyIndicesCount.length, "keyIndicesCount"), BufferLayout.seq(BufferLayout.u8("keyIndex"), instruction2.keyIndices.length, "keyIndices"), BufferLayout.blob(instruction2.dataLength.length, "dataLength"), BufferLayout.seq(BufferLayout.u8("userdatum"), instruction2.data.length, "data")]);
      const length2 = instructionLayout.encode(instruction2, instructionBuffer, instructionBufferLength);
...
var MessageV0 = class _MessageV0 {
  ...
  serializeInstructions() {
    ...
    for (const instruction2 of this.compiledInstructions) {
      const encodedAccountKeyIndexesLength = Array();
      encodeLength(encodedAccountKeyIndexesLength, instruction2.accountKeyIndexes.length);
      const encodedDataLength = Array();
      encodeLength(encodedDataLength, instruction2.data.length);
      const instructionLayout = BufferLayout.struct([BufferLayout.u8("programIdIndex"), BufferLayout.blob(encodedAccountKeyIndexesLength.length, "encodedAccountKeyIndexesLength"), BufferLayout.seq(BufferLayout.u8(), instruction2.accountKeyIndexes.length, "accountKeyIndexes"), BufferLayout.blob(encodedDataLength.length, "encodedDataLength"), BufferLayout.blob(instruction2.data.length, "data")]);
      serializedLength += instructionLayout.encode({
        programIdIndex: instruction2.programIdIndex,
        encodedAccountKeyIndexesLength: new Uint8Array(encodedAccountKeyIndexesLength),
        accountKeyIndexes: instruction2.accountKeyIndexes,
...
var CONFIG_MASK_PRIORITY_FEE_BITS = 3;
var CONFIG_MASK_COMPUTE_UNIT_LIMIT_BIT = 4;
...
var MessageV1 = class _MessageV1 {
  ...
  static deserialize(serializedMessage) {
    ...
    assert2(prefix !== maskedPrefix, `Expected versioned message but received legacy message`);
    const version2 = maskedPrefix;
    assert2(version2 === 1, `Expected versioned message with version 1 but found version ${version2}`);
    const header = {
      numRequiredSignatures: guardedShift(byteArray),
      numReadonlySignedAccounts: guardedShift(byteArray),
      numReadonlyUnsignedAccounts: guardedShift(byteArray)
    ...
    for (let i = 0; i < instructionCount; i++) {
      ...
      const dataLength = guardedShift(byteArray) + guardedShift(byteArray) * 256;
    ...
    for (const instructionHeader of instructionHeaders) {
      compiledInstructions.push({
        ...
        accountKeyIndexes: guardedSplice(byteArray, 0, instructionHeader.accountKeyIndexesLength),
...
var Transaction = class _Transaction {
  ...
  toJSON() {
    return {
      ...
      instructions: this.instructions.map((instruction2) => instruction2.toJSON()),
  ...
  compileMessage() {
    ...
    const accountMetas = [];
    instructions.forEach((instruction2) => {
      instruction2.keys.forEach((accountMeta) => {
        accountMetas.push({
          ...accountMeta
        });
      });
      const programId = instruction2.programId.toString();
    ...
    const compiledInstructions = instructions.map((instruction2) => {
      const {
        data,
        programId
      } = instruction2;
      return {
        ...
        accounts: instruction2.keys.map((meta) => accountKeys.indexOf(meta.pubkey.toString())),
        data: import_bs58.default.encode(data)
      };
    });
    compiledInstructions.forEach((instruction2) => {
      assert2(instruction2.programIdIndex >= 0);
      instruction2.accounts.forEach((keyIndex) => assert2(keyIndex >= 0));
    });
    return new Message({
      header: {
        numRequiredSignatures,
...
Missing signature for public key${sigErrors.missing.length === 1 ? "" : "(s)"} [\`${sigErrors.missing.map((p) => p.toBase58()).join("`, `")}\`].`;
  ...
  static populate(message, signatures = []) {
    ...
    message.instructions.forEach((instruction2) => {
      const keys = instruction2.accounts.map((account) => {
      ...
      transaction.instructions.push(new TransactionInstruction({
        keys,
        programId: message.accountKeys[instruction2.programIdIndex],
        data: import_bs58.default.decode(instruction2.data)
      }));
    });
...
function versionedMessageFromResponse(version2, response) {
  if (version2 === 0) {
    ...
    if (transactionConfig == null) {
      throw new Error("Expected a version 1 transaction message response to have a `transactionConfig`");
    }
...
var TransactionConfigResult = type({
...
var TransactionVersionStruct = union([literal(0), literal(1), literal("legacy")]);
...
var Connection = class {
  ...
  async getLargestAccounts(config) {
    ...
    const args = arg2.filter || arg2.commitment ? [arg2] : [];
...
var DEFAULT_PROGRAM_ID = new PublicKey("EgaRMf8t5gnqEXa37xW9BYxgEiSmTsF2FkNfxr2kbyuh");
...
function componentId(name) {
  ...
  return sha2562(encoder.encode(name));
}
function pda(kind, nameOrId, programId = DEFAULT_PROGRAM_ID, owner) {
  const id = typeof nameOrId === "string" ? componentId(nameOrId) : nameOrId;
  const seeds = [encoder.encode(kind)];
  if (kind !== "config") seeds.push(id);
  if (kind === "license") seeds.push(publicKey2(owner).toBuffer());
  return PublicKey.findProgramAddressSync(seeds, publicKey2(programId))[0];
}
function discriminator(scope, name) {
  return sha2562(encoder.encode(scope + ":" + name)).slice(0, 8);
}
function bytes32(value) {
  const bytes = typeof value === "string" ? Uint8Array.from(import_buffer3.Buffer.from(value.replace(/^0x/, ""), "hex")) : value;
...
function u642(value) {
  ...
  const out = import_buffer3.Buffer.alloc(8);
  out.writeBigUInt64LE(n);
  return out;
}
function string2(value) {
  const data = encoder.encode(value);
  const size = import_buffer3.Buffer.alloc(4);
  size.writeUInt32LE(data.length);
  return import_buffer3.Buffer.concat([size, import_buffer3.Buffer.from(data)]);
}
function instruction(name, args, accounts, programId = DEFAULT_PROGRAM_ID) {
  return new TransactionInstruction({
    programId: publicKey2(programId),
    keys: accounts.map(([key, isSigner = false, isWritable = false]) => ({
      pubkey: publicKey2(key),
      isSigner,
      isWritable
    })),
    data: import_buffer3.Buffer.concat([import_buffer3.Buffer.from(discriminator("global", name)), ...args.map(import_buffer3.Buffer.from)])
  });
}
var arg = Object.freeze({
  id: bytes32,
  u64: u642,
  bool: (value) => import_buffer3.Buffer.from([value ? 1 : 0]),
  string: string2,
  u16: (value) => {
    if (!Number.isInteger(value) || value < 0 || value > 65535) throw new Error("invalid u16");
    const out = import_buffer3.Buffer.alloc(2);
    out.writeUInt16LE(value);
    return out;
  },
  key: (value) => publicKey2(value).toBuffer()
});
function checked(data, name) {
  const bytes = import_buffer3.Buffer.from(data);
  if (bytes.length < 8 || !bytes.subarray(0, 8).equals(import_buffer3.Buffer.from(discriminator("account", name)))) {
...
var MarketClient = class {
  constructor({ wallet, connection: connection2, programId = DEFAULT_PROGRAM_ID }) {
    if (!wallet?.publicKey || !wallet?.signTransaction) throw new Error("Solana wallet with signTransaction is required");
    if (!connection2?.getAccountInfo || !connection2?.getLatestBlockhash) throw new Error("Solana connection is required");
    this.wallet = wallet;
    this.connection = connection2;
    this.programId = publicKey2(programId);
  }
  async initializeConfig(treasury, feeBps = 250) {
    if (!Number.isInteger(feeBps) || feeBps < 0 || feeBps > 1e3) throw new Error("feeBps must be 0 to 1000");
  ...
  async publish(untrustedManifest, metadataURI) {
    ...
    return this.#send("publish", [
      arg.id(componentId(manifest.id)),
      arg.id(manifest.codeHash),
      arg.string(metadataURI)
    ], [
  ...
  async createListing({ componentName, price, duration, transferable = false }) {
    ...
    if (!Number.isSafeInteger(duration) || duration < 3600 || duration > 31536e4) {
      throw new Error("duration must be between one hour and ten years");
    }
    return this.#send("create_listing", [
      arg.id(componentId(componentName)),
      arg.u64(price),
      arg.u64(duration),
      arg.bool(transferable)
    ], [
  ...
  async getListing(componentName) {
    ...
    if (!listing.componentId.equals(import_buffer4.Buffer.from(componentId(componentName)))) {
  ...
  async purchase(componentName, expectedPrice) {
    ...
    if (expectedPrice !== void 0 && listing.price !== expectedPrice) throw new Error("Onchain price differs from displayed price");
  ...
  async transfer(componentName, recipient) {
    const recipientKey = publicKey2(recipient);
  ...
  async #send(name, args, accounts) {
    ...
    const transaction = new Transaction({ feePayer: publicKey2(this.wallet.publicKey), recentBlockhash: latest.blockhash }).add(ix);
...
// src/networks.js
var solanaDevnet = Object.freeze({
  name: "Solana Devnet",
  rpcUrl: "https://api.devnet.solana.com",
  explorer: "https://explorer.solana.com",
  cluster: "devnet"
});
var solanaMainnet = Object.freeze({
  name: "Solana Mainnet",
  rpcUrl: "https://api.mainnet.solana.com",
  explorer: "https://explorer.solana.com",
  cluster: "mainnet-beta"
});
function createConnection(network = solanaDevnet, rpcUrl = network.rpcUrl) {
  return new Connection(rpcUrl, "confirmed");
}

// src/license-providers.js
var ChainLicenseProvider = class {
  constructor({ programId = DEFAULT_PROGRAM_ID, network = solanaDevnet, rpcUrl, connection: connection2 } = {}) {
    this.programId = publicKey2(programId);
    this.connection = connection2 ?? createConnection(network, rpcUrl);
  }
  async hasAccess(owner, componentName, codeHash) {
    ...
    if (!component || !license || !component.owner.equals(this.programId) || !license.owner.equals(this.programId)) return false;
    const id = componentId(componentName);
    const record2 = decodeComponent(component.data);
    const access = decodeLicense(license.data);
    return record2.active && record2.id.equals(import_buffer5.Buffer.from(id)) && (!codeHash || record2.codeHash.equals(import_buffer5.Buffer.from(codeHash.replace(/^0x/, ""), "hex"))) && access.componentId.equals(import_buffer5.Buffer.from(id)) && access.owner.equals(publicKey2(owner)) && access.expiresAt > Math.floor(Date.now() / 1e3);
  }
};
...
function renderCatalog() {
  ...
  $("#catalog").innerHTML = items.map((item) => {
    ...
    return '<article class="card ' + (state.selected?.id === item.id ? "selected" : "") + '" data-id="' + item.id + '"><div class="card-top"><span class="card-icon">' + item.icon + '</span><span class="card-category">' + item.category.toUpperCase() + "</span></div><h2>" + escapeHtml(item.name) + "</h2><p>" + escapeHtml(item.description) + '</p><div class="card-foot"><div class="price"><strong>' + item.price + "</strong><small>" + item.term + '</small></div><button data-buy="' + item.id + '">' + (installed ? "INSTALLED" : item.lamports === 0n ? "INSTALL" : "ACQUIRE") + "</button></div></article>";
...
async function acquire(item) {
  ...
  try {
    if (state.installed.includes(item.id)) {
      if (!chainConfigured() || item.lamports === 0n) {
        await launch(item);
        return;
      }
      if (state.account) {
        const licenses = new ChainLicenseProvider({
          programId: state.config.programId,
    ...
    if (!state.installed.includes(item.id)) state.installed.push(item.id);
    save();
